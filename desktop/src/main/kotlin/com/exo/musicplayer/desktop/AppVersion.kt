 ...
 *
 * Set by the launcher as -Dlucense.version, which the Gradle build fills from
 * the single `lucenseVersion` property that also becomes the MSI
 ...
 */
object AppVersion {
    val name: String = System.getProperty("lucense.version")?.takeIf { it.isNotBlank() } ?: "dev"
}
